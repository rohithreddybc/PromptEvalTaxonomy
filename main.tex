...
the technique catalog. Recent automated-prompt-optimization surveys
\cite{li2025autoprompt, ramnath2025apo} organize this territory but
do not address the evaluation question: once a prompting method
exists, how do you know it worked, and by what standard?
\cite{schulhoff2024prompt, sahoo2024systematic}.
...
(BERTScore family), handling paraphrase more gracefully but still
requiring a reference~\cite{chang2023survey}. \textbf{LLM-as-judge
...
\textit{Takeaway:} The strongest co-occurrence (D1=LLM-judge \& D3=LLM-judge at 21.1\%) is consistent with evaluation-method choice cascading through metric choice; the taxonomy dimensions are therefore informative about one another --- knowing D1 substantially narrows the likely values of D3, D4, and D7 in this corpus.}
