...
42 papers (27.6\%) carry the FM3 fingerprint (D5=Cross-model with
D6=Single-prompt), including chain-of-thought~\cite{wei2022chain}
and zero-shot CoT~\cite{kojima2022large}. Cross-model claims under
single-prompt support narrower conclusions than their phrasing
suggests.
