...
but because no shared standard has emerged in the surveyed work on
what should be measured or how. We trace this to two unresolved
tensions from measurement theory: construct validity
vs.\ measurement reliability, and reference-anchored
vs.\ judgment-anchored evaluation. Existing evaluation choices
project onto these tensions in identifiable, predictable ways.
...
level, evaluation scope, robustness, and reproducibility. We apply
...
calibration, and clinical/legal domain evaluation) and use it to
...
concerns that the surveyed work has not yet managed with a shared
calibration protocol. Robustness and contamination-resistant
evaluation appear as reported properties in only a minority of
papers, suggesting these checks are not yet standard.
