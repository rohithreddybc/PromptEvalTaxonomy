...
A useful taxonomy of evaluation frameworks should not only catalog
choices but interpret why they cluster as they do. We frame the
configuration space as structured by two largely orthogonal tensions
...
evaluation (Definitions~4--5). The seven dimensions in
Sections~\ref{subsec:d1}--\ref{subsec:d7} project onto these axes in
identifiable ways, and the configurations papers adopt cluster in
regions the frame anticipates. Figure~\ref{fig:taxonomy} positions
...
concentrated in the benchmark-paper category; strong reproducibility
requires both.
