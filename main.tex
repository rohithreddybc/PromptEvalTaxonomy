...
corpus of 152 papers, the taxonomy identifies three recurring
...
\textit{Takeaway:} D1--D5 all reach ``almost perfect'' agreement ($\kappa \geq 0.84$, well above the Landis \& Koch 0.81 threshold); D6--D7 reach ``substantial'' agreement ($\kappa = 0.76$ and $0.78$), indicating that robustness and reproducibility coding requires more interpretive judgment than the procedural dimensions -- as expected for properties not always explicitly reported in paper text.}
\label{tab:kappa}
\centering
\footnotesize
