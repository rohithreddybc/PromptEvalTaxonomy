...
We develop a seven-dimensional taxonomy (D1--D7: evaluation method,
...
recurring archetypes supported by silhouette analysis and unsupervised
$k$-means clustering (Benchmark-Automation, Judge-Mediated,
Expert-Anchored), strong dimension-pair dependencies
(Cram\'{e}r's~$V$ up to 0.702), and three named failure modes
(FM1: Construct Mismatch; FM2: Unpinned Judge; FM3: Single-Phrasing
Generalization) where an evaluation design does not support its
stated claims.

Three patterns emerge. The dominant archetype (Benchmark-Automation,
65.7\% of the corpus) occupies the high-reliability, narrow-validity
region: well-suited to tasks with ground-truth answers but
under-specifying the construct for open-ended generation. The
Judge-Mediated archetype (17.2\%) addresses this gap at the cost of
...
the first systematic treatment of prompt engineering evaluation through
a measurement-theoretic frame, providing a stable reference vocabulary
(D1--D7, FM1--FM3, archetype labels) that subsequent work can cite to
disclose and compare evaluation methodology. A companion
seven-question checklist supports immediate practitioner use.
\end{abstract}
