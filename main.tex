...
D6=Single-prompt; Section~\ref{subsec:failuremodes}), including the
original chain-of-thought paper~\cite{wei2022chain} and zero-shot
CoT~\cite{kojima2022large}. Cross-model claims under D6=Single-prompt
support narrower conclusions than their phrasing suggests; the
dimensional coding makes this identifiable across more than a
